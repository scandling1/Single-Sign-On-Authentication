...
using SsoProject.Admin.Api.Configuration;
using SsoProject.Admin.Api.Configuration.Authorization;
using SsoProject.Admin.Api.ExceptionHandling;
using SsoProject.Admin.Api.Helpers;
using SsoProject.Admin.Api.Mappers;
using SsoProject.Admin.Api.Resources;
...
using SsoProject.Shared.Dtos;
using SsoProject.Shared.Dtos.Identity;

namespace SsoProject.Admin.Api
{
